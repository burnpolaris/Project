...
for t=1:timeSteps 
    ...
    for i=1:N 
        for j=1:N  
                      ...
                      if direction <= 0.25
                          m = -1; n = 0;
                      elseif direction <= 0.5 && direction > 0.25
                          m = 0; n = -1;
                      elseif direction <= 0.75 && direction > 0.5
                          m = 0; n = 1;
                    ...
                    J = j + n;  
                      ...
                      if I>0 && I<=N && J>0 && J<=N  
                           ...
                           elseif payoff(I,J)==tempPayoff && currentPlayer(I,J)==1 
                                tempPlayer(i,j)=currentPlayer(I,J); 
                           elseif payoff(I,J)==tempPayoff && currentPlayer(I,J)==2
                                tempPlayer(i,j)=currentPlayer(I,J);
                           elseif payoff(I,J)==tempPayoff && currentPlayer(I,J)==3
                                tempPlayer(i,j)=currentPlayer(I,J);
                           end 
                      end 
                  end 
